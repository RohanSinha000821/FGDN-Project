...
base = project_root / "outputs" / "ablations" / "AAL_10fold_final"
...
for candidate_dir in sorted(base.iterdir()):
    ...
    for fold_dir in sorted(candidate_dir.glob("fold_*")):
        ...
        json_files = list(
            fold_dir.glob("tables/fgdn/AAL/10_fold/fold_*/best_evaluation.json")
        )
...
detail_path = out_dir / "aal_10fold_final_details.csv"
summary_path = out_dir / "aal_10fold_final_summary.csv"
md_path = out_dir / "aal_10fold_final_summary.md"
